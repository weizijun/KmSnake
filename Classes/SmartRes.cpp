...
CSmartRes* CSmartRes::s_sharedRes = NULL;

CSmartRes* CSmartRes::sharedRes(void)
{
    if (!s_sharedRes)
    {
        s_sharedRes = new CSmartRes();
        s_sharedRes->init();
    }
    return s_sharedRes;
}

bool CSmartRes::init(void)
{
...
void CSmartRes::setVirtualScreenWidth(float width)
{
